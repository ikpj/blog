            ...
            <div class="col-md-10 col-lg-8 col-xl-7 mb-5">
                ...
                <form action="{{ route('auth.login.login') }}" method="post">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input name="{{ \App\Models\User::EMAIL }}" type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter email" value="{{ old(\App\Models\User::EMAIL) }}">
