...
@section('content')
    @component('components.banner', ['title' => 'Clean Blog', 'subTitle' => 'A Blog Theme by Start Bootstrap', 'image' => asset('/assets/img/home-bg.jpg')])
    @endcomponent
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <!-- Post preview-->
                <div class="post-preview">
                    <a href="post.html"><h2 class="post-title">I believe every human has a finite number of heartbeats.
